    ...
    <main class="homepage">
        <section id="universityIntro">
            <div class="container">
                ...
                <p>Welcome, 
                <?php 
                // welcomes the logged in user, or 'guest' if none logged in
                ...
                <?php
                    // fetches all offers in the database's offers table, which are then dynamically displayed
                ...
                <!--Textual & video introduction to the university & Preston-->
                <h3>LEADING THE WAY IN MODERN LEARNING</h3><hr>
                <p>The University of Central Lancashire is the international, multi-campus university tracing its roots
                    back to 1828 and leading the way in modern learning today.</p>
